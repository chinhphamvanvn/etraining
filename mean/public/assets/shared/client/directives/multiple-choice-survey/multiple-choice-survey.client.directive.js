(function () {
  ...
  angular.module('shared')
    .directive('multipleChoiceSurvey', ['OptionsService','QuestionsService','_', multipleChoiceSurvey]);

  function multipleChoiceSurvey(OptionsService,QuestionsService,_) {
      ...
      return {
          ...
          templateUrl:'/modules/shared/client/directives/multiple-choice-survey/multiple-choice-survey.directive.client.view.html',
