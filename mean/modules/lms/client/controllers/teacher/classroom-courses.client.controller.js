    ...
    vm.classConfig = {
        ...
        function selectClass() {
            if (vm.classroomId) {
                ...
                CourseMembersService.byClass({classroomId:vm.classroomId},function(members) {
                    vm.members = vm.members.concat(members);
                    _.each(vm.members ,function(member) {
                       ConferenceParticipantsService.byMember({memberId:member._id},function(conferenceMember) {
