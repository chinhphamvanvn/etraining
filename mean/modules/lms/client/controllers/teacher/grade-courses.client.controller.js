    ...
    function update() {
      ...
      vm.scheme.$update(function() {
        Notification.success({
          message: '<i class="uk-icon-ok"></i> Grade scheme  created successfully!'
        });
      }, function(errorResponse) {
        Notification.error({
          message: errorResponse.data.message,
          title: '<i class="uk-icon-ban"></i> Grade scheme updated error!'
        });
      });
    }
