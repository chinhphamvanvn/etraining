(function () {
    ...
    ExamsGradeController.$inject = ['$scope', '$state', '$filter', '$compile','Authentication', 'Notification', '$timeout', '$location', '$window', 'courseResolve','editionResolve','schemeResolve','EditionSectionsService','treeUtils', '$translate', '_'];

    function ExamsGradeController($scope,$state, $filter, $compile, Authentication, Notification, $timeout, $location, $window, course, edition, scheme, EditionSectionsService, treeUtils, $translate, _) {
      var vm = this;
      vm.course = course;
      vm.edition = edition;
      vm.scheme = scheme;
