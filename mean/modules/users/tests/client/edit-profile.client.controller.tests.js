  ...
  describe('Edit Profile Controller Tests', function () {
    ...
    describe('Update User Profile', function () {
      ...
      it('should update the user profile', inject(function (UsersService) {
        ...
        expect(Notification.success).toHaveBeenCalledWith({ message: '<i class="uk-icon-check"></i> Edit profile successful!' });
      }));
      ...
      it('should call Notification.error if error', inject(function (UsersService) {
        ...
        expect(Notification.error).toHaveBeenCalledWith({ message: errorMessage, title: '<i class="uk-icon-ban"></i> Edit profile failed!' });
      }));
    });
