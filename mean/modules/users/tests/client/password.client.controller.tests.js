    ...
    describe('Logged out user', function() {
      ...
      describe('askForPasswordReset', function() {
        ...
        describe('POST error', function() {
          ...
          it('should call Notification.error with response message', function() {
            expect(Notification.error).toHaveBeenCalledWith({ message: errorMessage, title: '<i class="uk-icon-ban"></i> Failed to send password reset email!', delay: 4000 });
          });
        });
        ...
        describe('POST success', function() {
          ...
          it('should call Notification.success with response message', function() {
            expect(Notification.success).toHaveBeenCalledWith({ message: successMessage, title: '<i class="uk-icon-check"></i> Password reset email sent successfully!' });
          });
        });
      });
      ...
      describe('resetUserPassword', function() {
        ...
        it('POST error should call Notification.error with response message', function() {
          ...
          expect(Notification.error).toHaveBeenCalledWith({ message: errorMessage, title: '<i class="uk-icon-ban"></i> Password reset failed!', delay: 4000 });
        });
        ...
        describe('POST success', function() {
          ...
          it('should redirect to password reset success view with Notification.success', function() {
            expect(Notification.success).toHaveBeenCalledWith({ message: '<i class="uk-icon-check"></i> Password reset successful!' });
