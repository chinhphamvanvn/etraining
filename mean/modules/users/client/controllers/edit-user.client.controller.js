  ...
  function UserEditController($scope, $state, $rootScope, $window, user, Authentication, Notification, Upload, UsersService, localStorageService, _) {
    ...
    function changeUserPassword() {
      ...
      function onChangePasswordSuccess(response) {
        ...
        Notification.success({ message: '<i class="uk-icon-check"></i> Password Changed Successfully' });
        vm.passwordDetails = null;
      }

      function onChangePasswordError(response) {
        Notification.error({ message: response.data.message, title: '<i class="uk-icon-ban"></i> Password change failed!' });
      }
      ...
      function onRemoveSocialAccountSuccess(response) {
        // If successful show success message and clear form
        Notification.success({ message: '<i class="uk-icon-check"></i> Removed successfully!' });
        vm.user = Authentication.user = response;
      }

      function onRemoveSocialAccountError(response) {
        Notification.error({ message: response.message, title: '<i class="uk-icon-ban"></i> Remove failed!' });
      }
