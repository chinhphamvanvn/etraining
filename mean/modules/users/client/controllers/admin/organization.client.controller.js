(function () {
  ...
  OrganizationController.$inject = [ '$scope', '$state', '$stateParams', '$timeout', '$location', '$window', 'GroupsService', 'Notification', 'treeUtils', '_'];

  function OrganizationController( $scope, $state, $stateParams, $timeout, $location, $window, GroupsService, Notification, treeUtils, _) {
    var vm = this;
    vm.create = create;
    vm.remove = remove;
    vm.rename = rename;
