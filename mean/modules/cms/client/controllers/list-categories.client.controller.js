(function () {
    ...
    angular
      .module('cms')
      .controller('CourseCategoriesListController', CourseCategoriesListController);

    CourseCategoriesListController.$inject = [ '$scope', '$state', '$stateParams', '$timeout', '$location', '$window', 'GroupsService', 'Notification', 'treeUtils', '_'];

    function CourseCategoriesListController( $scope, $state, $stateParams, $timeout, $location, $window, GroupsService, Notification, treeUtils, _) {
      var vm = this;
      vm.create = create;
      vm.remove = remove;
      vm.rename = rename;
