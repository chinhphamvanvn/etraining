...
function CoursesController($scope, $state, $window, Authentication, $timeout, course, CoursesService, Notification, GroupsService,Upload ,fileManagerConfig, _) {
    ...
    function activate() {
        ...
        vm.course.$update(
          function() {
            Notification.success({ message: '<i class="uk-icon-check"></i> Course activated successfully!'})},
          function() {
            Notification.success({ message: '<i class="uk-icon-check"></i> Course activated failed!' });
        })
    }
    ...
    function deactivate() {
        ...
        vm.course.$update(
            function() {
                Notification.success({ message: '<i class="uk-icon-check"></i> Course deactivated successfully!'})},
            function() {
                Notification.success({ message: '<i class="uk-icon-check"></i> Course deactivated failed!' });
        });   
    }     
