(function () {
    ...
    angular
      .module('performance')
      .controller('QuestionCategoriesController', QuestionCategoriesController);

    QuestionCategoriesController.$inject = [ '$scope', '$state', '$stateParams', '$timeout', '$location', '$window', 'GroupsService', 'Notification', 'treeUtils', '_'];

    function QuestionCategoriesController( $scope, $state, $stateParams, $timeout, $location, $window, GroupsService, Notification, treeUtils, _) {
      var vm = this;
      vm.create = create;
      vm.remove = remove;
      vm.rename = rename;
