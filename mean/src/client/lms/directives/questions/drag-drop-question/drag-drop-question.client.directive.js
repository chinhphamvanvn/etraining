(function() {
  ...
  angular.module('lms')
    .directive('dragDropQuestion', ['OptionsService', 'QuestionsService', 'fileManagerConfig', '$filter', '_', dragDropQuestion]);

  function dragDropQuestion(OptionsService, QuestionsService, fileManagerConfig, $filter, _) {
    return {
      scope: {
        question: '=',
        answer: '=',
