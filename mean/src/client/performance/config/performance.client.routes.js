  ...
  function routeConfig($stateProvider) {
    ...
    $stateProvider
      ...
      .state('admin.workspace.performance.question.list', {
        url: '/list',
        templateUrl: '/src/client/performance/client/views/list-questions.client.view.html',
      ...
      .state('admin.workspace.performance.question.edit', {
        url: '/edit/:questionId',
        templateUrl: '/src/client/performance/client/views/form-question.client.view.html',
      ...
      .state('admin.workspace.performance.question.view', {
        url: '/view/:questionId',
        templateUrl: '/src/client/performance/client/views/view-question.client.view.html',
        controller: 'QuestionController',
        controllerAs: 'vm',
        resolve: {
          questionResolve: getQuestion
      ...
      .state('admin.workspace.performance.schedules.list', {
        url: '/list',
        templateUrl: '/src/client/performance/client/views/list-schedules.client.view.html',
      ...
      .state('admin.workspace.performance.schedules.edit', {
        url: '/edit/:scheduleId',
        templateUrl: '/src/client/performance/client/views/form-schedule.client.view.html',
      ...
      .state('admin.workspace.performance.schedules.view', {
        url: '/view/:scheduleId',
        templateUrl: '/src/client/performance/client/views/view-schedule.client.view.html',
      ...
      .state('admin.workspace.performance.schedules.candidate', {
        ...
        templateUrl: '/src/client/performance/client/views/list-exam-candidates.client.view.html',
      ...
      .state('admin.workspace.performance.competency.list', {
        url: '/list',
        templateUrl: '/src/client/performance/client/views/list-competencies.client.view.html',
      ...
      .state('admin.workspace.performance.competency.edit', {
        ...
        templateUrl: '/src/client/performance/client/views/form-competency.client.view.html',
      ...
      .state('admin.workspace.performance.competency.view', {
        ...
        templateUrl: '/src/client/performance/client/views/view-competency.client.view.html',
        controller: 'CompetencyController',
        controllerAs: 'vm',
        resolve: {
          competencyResolve: getCompetency
