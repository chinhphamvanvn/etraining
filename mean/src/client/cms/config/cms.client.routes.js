  ...
  function routeConfig($stateProvider) {
    $stateProvider
      ...
      .state('admin.workspace.cms.courses.list', {
        url: '/list',
        templateUrl: '/src/client/cms/views/list-courses.client.view.html',
      ...
      .state('admin.workspace.cms.courses.create', {
        url: '/create',
        templateUrl: '/src/client/cms/views/form-course.client.view.html',
      ...
      .state('admin.workspace.cms.courses.view', {
        url: '/view/:courseId',
        templateUrl: '/src/client/cms/views/view-course.client.view.html',
      ...
      .state('admin.workspace.cms.course-members', {
        ...
        templateUrl: '/src/client/cms/views/list-course.members.client.view.html',
      ...
      .state('admin.workspace.cms.programs.list', {
        url: '/list',
        templateUrl: '/src/client/cms/views/list-programs.client.view.html',
      ...
      .state('admin.workspace.cms.programs.create', {
        url: '/create',
        templateUrl: '/src/client/cms/views/form-program.client.view.html',
      ...
      .state('admin.workspace.cms.programs.view', {
        url: '/view/:programId',
        templateUrl: '/src/client/cms/views/view-program.client.view.html',
      ...
      .state('admin.workspace.cms.program-members', {
        ...
        templateUrl: '/src/client/cms/views/list-program.members.client.view.html',
