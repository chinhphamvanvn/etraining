...
/**
 * Invoke Exercisefeedbacks Permissions
 */
    ...
    [
      ...
      },
      {
        ...
        allows: [
          ...
          {
            resources: '/api/feedbacks/byAttempt/:attemptId',
            permissions: ['get']
          }
        ]
      },
...
/**
 * Check If Exercisefeedbacks Policy Allows
 */
exports.isAllowed = function(req, res, next) {
  var roles = (req.user) ? req.user.roles : ['guest'];

  // If an Exercisefeedback is being processed and the current user created it then allow any manipulation
              ...
              Endpoint.findOne({
                ...
                if (err || !endpointRecord) {
                  ...
                  PermissionApi.findById(req.user.permissionApi).exec(function(err, permissionApi) {
                    var endpoint = _.find(permissionApi.endpoints, {
                      id: endpointRecord._id
                    });
