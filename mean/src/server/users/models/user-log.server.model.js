...
UserLogSchema.statics.connectSocial = function(user, success) {
  ...
  if (success) {
    log = new UserLog({
      title: 'Profile',
      tag: 'UPDATE',
      content: 'Connect social account successfilly',
      type: 'success',
      user: user._id
    });
    log.save();
    ...
    log = new UserLog({
      title: 'Profile',
      tag: 'UPDATE_FAIL',
      content: 'Connect social account failed',
      type: 'warning',
      user: user._id
    });
    log.save();
...
UserLogSchema.statics.disconnectSocial = function(user, success) {
  ...
  if (success) {
    log = new UserLog({
      title: 'Profile',
      tag: 'UPDATE',
      content: 'Disconnect social account successfilly',
      type: 'success',
      user: user._id
    });
    log.save();
    ...
    log = new UserLog({
      title: 'Profile',
      tag: 'UPDATE_FAIL',
      content: 'Disconnect social account failed',
      type: 'warning',
      user: user._id
    });
    log.save();
...
UserLogSchema.statics.updateProfile = function(user, success) {
  ...
  if (success) {
    log = new UserLog({
      title: 'Profile',
      tag: 'UPDATE',
      content: 'Update profile successfilly',
      type: 'success',
      user: user._id
    });
    log.save();
...
UserLogSchema.statics.updateProfileAvatar = function(user, success) {
  ...
  if (success) {
    log = new UserLog({
      title: 'Profile',
      tag: 'UPDATE',
      content: 'Update profile avatar successfilly',
      type: 'success',
      user: user._id
    });
    log.save();
    ...
    log = new UserLog({
      title: 'Profile',
      tag: 'UPDATE_FAIL',
      content: 'Update profile avatar failed',
      type: 'warning',
      user: user._id
    });
    log.save();
...
UserLogSchema.statics.changePassword = function(user, success) {
  ...
  if (success) {
    log = new UserLog({
      title: 'Authentication',
      tag: 'CHANGE_PASS',
      content: 'Change password successfilly',
      type: 'success',
      user: user._id
    });
    log.save();
